  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      <Card className="glass-card card-3d shadow-3d border-0 animate-float">
        ...
        <CardContent>
          <div className="text-2xl font-bold text-white">{summary.nombreCharges}</div>
      ...
      <Card className="glass-card card-3d shadow-3d border-0 animate-float" style={{ animationDelay: '0.1s' }}>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-white">{formatCurrency(summary.totalHT)}</div>
          <p className="text-xs text-white/60 mt-1">
            hors taxes
          </p>
        </CardContent>
      ...
      <Card className="glass-card card-3d shadow-3d border-0 animate-float" style={{ animationDelay: '0.2s' }}>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-white">{formatCurrency(summary.totalTVA)}</div>
          <p className="text-xs text-white/60 mt-1">
            taxes
          </p>
        </CardContent>
      ...
      <Card className="glass-card card-3d shadow-3d border-0 animate-float animate-glow" style={{ animationDelay: '0.3s' }}>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-white">{formatCurrency(summary.totalTTC)}</div>
          <Button 
            onClick={handleExportPDF}
            size="sm" 
            className="mt-2 w-full bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white border-0 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
          >
