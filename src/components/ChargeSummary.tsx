    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6 lg:mb-8">
      <Card className="glass-card card-3d shadow-3d border-0 animate-float">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 px-3 sm:px-4 pt-3 sm:pt-4">
          ...
          <Receipt className="h-3 w-3 sm:h-4 sm:w-4 text-purple-300" />
        </CardHeader>
        <CardContent className="px-3 sm:px-4 pb-3 sm:pb-4">
          <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white">{summary.nombreCharges}</div>
      ...
      <Card className="glass-card card-3d shadow-3d border-0 animate-float" style={{ animationDelay: '0.1s' }}>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 px-3 sm:px-4 pt-3 sm:pt-4">
          ...
          <Calculator className="h-3 w-3 sm:h-4 sm:w-4 text-blue-300" />
        </CardHeader>
        <CardContent className="px-3 sm:px-4 pb-3 sm:pb-4">
          <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white">{formatCurrency(summary.totalHT)}</div>
          <p className="text-xs text-white/60 mt-1">
            hors taxes
          </p>
        </CardContent>
      ...
      <Card className="glass-card card-3d shadow-3d border-0 animate-float" style={{ animationDelay: '0.2s' }}>
        ...
        <CardContent className="px-3 sm:px-4 pb-3 sm:pb-4">
          <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white">{formatCurrency(summary.totalTVA)}</div>
          <p className="text-xs text-white/60 mt-1">
            taxes
          </p>
        </CardContent>
      ...
      <Card className="glass-card card-3d shadow-3d border-0 animate-float animate-glow" style={{ animationDelay: '0.3s' }}>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 px-3 sm:px-4 pt-3 sm:pt-4">
          ...
          <Download className="h-3 w-3 sm:h-4 sm:w-4 text-yellow-300" />
        </CardHeader>
        <CardContent className="px-3 sm:px-4 pb-3 sm:pb-4">
          <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white">{formatCurrency(summary.totalTTC)}</div>
          <Button 
            onClick={handleExportPDF}
            size="sm" 
            className="mt-2 w-full bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white border-0 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-xs sm:text-sm h-7 sm:h-8"
          >
